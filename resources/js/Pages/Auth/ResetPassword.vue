        ...
        <div class="w-full max-w-[420px] bg-white/80 backdrop-blur-xl rounded-[2rem] shadow-2xl border border-white/60 relative z-10 overflow-hidden transition-all duration-300 hover:shadow-black/5">
            ...
            <div class="p-8 sm:p-10">
                <div class="text-center mb-8">
                    ...
                    <p class="mt-2 text-sm text-gray-500 font-medium">Enter your new password below.</p>
                </div>
                ...
                <form @submit.prevent="submit" class="space-y-5">
                    ...
                    <div class="space-y-1.5">
                        <label for="password" class="block text-xs font-bold text-gray-700 uppercase tracking-wide">New Password</label>
                        <input 
                            id="password" 
                            type="password" 
                    ...
                    <div class="space-y-1.5">
                        <label for="password_confirmation" class="block text-xs font-bold text-gray-700 uppercase tracking-wide">Confirm Password</label>
                        <input 
                            ...
                            placeholder="••••••••"
                        />
                        <div v-if="form.errors.password_confirmation" class="text-red-500 text-xs font-medium mt-1">{{ form.errors.password_confirmation }}</div>
                    </div>
                ...
                <p class="text-center text-sm text-gray-500 mt-8">
                    ...
                    <Link :href="route('login')" class="font-semibold text-black hover:underline transition-all">Back to login</Link>
                </p>
            </div>
        </div>
    </div>
