        ...
        <div class="w-full max-w-[420px] bg-white/80 backdrop-blur-xl rounded-[2rem] shadow-2xl border border-white/60 relative z-10 overflow-hidden transition-all duration-300 hover:shadow-black/5">
            ...
            <div class="p-8 sm:p-10">
                <div class="text-center mb-8">
                    ...
                    <p class="mt-2 text-sm text-gray-500 font-medium">No problem. Just enter your email and we'll send you a reset link.</p>
                </div>

                <div v-if="status" class="mb-6 p-3 rounded-xl bg-green-50 border border-green-200 text-sm font-medium text-green-600 text-center">
                    {{ status }}
                </div>
